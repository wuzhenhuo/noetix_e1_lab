...
import NoetixE1.terrains as terrain_gen
...
GRAVEL_TERRAINS_CFG = TerrainGeneratorCfg(
    ...
    sub_terrains={
        "random_rough": terrain_gen.HfRandomUniformTerrainCfg(
            proportion=0.6, noise_range=(-0.02, 0.05), noise_step=0.01
        ),
        "slope_up": terrain_gen.HfPyramidSlopedTerrainCfg(
            proportion=0.2, slope_range=(0.1, 0.25)
        ),
...
MIMIC_TERRAINS_CFG = TerrainGeneratorCfg(
    curriculum=False,
    size=(8.0, 8.0),
    border_width=20.0,
    num_rows=10,
    ...
    use_cache=False,
    sub_terrains={
        "wave": terrain_gen.HfWaveTerrainCfg(proportion=0.5, num_waves=10.0, amplitude_range=(0.02, 0.05)),
        "random_rough": terrain_gen.HfRandomUniformTerrainCfg(
            proportion=0.5, noise_range=(0.01, 0.05), noise_step=0.015
        ),
    },
)
