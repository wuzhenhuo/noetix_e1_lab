...
# Ablation: + Contact Mask
# Change vs walkrun_cfg.py: added feet_contact ObsTerm to PolicyCfg so the
# actor can observe which feet are grounded (gait phase awareness).
...
class ObservationsCfg:
    ...
    class PolicyCfg(ObsGroup):
        ...
        # [Contact Mask] feet contact state added to actor observations
