...
# Change vs walkrun_cfg.py: rnd_state observation group uncommented so the
# RND module receives its input state from the environment.
# The matching agent cfg (rsl_rl_amp_ppo_cfg_curiosity) enables rnd_cfg.
...
class ObservationsCfg:
    ...
    rnd_state: RndObsCfg = RndObsCfg()   # [Curiosity Reward] activated for RND input
