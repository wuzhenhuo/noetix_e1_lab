...
def generated_commands(env: ManagerBasedRLEnv, command_name: str | None = None, obs_command_type: str | None = None) -> torch.Tensor:
    """The generated command from command term in the command manager with the given name."""
    base_vel_command, motion_command = env.command_manager.get_command(command_name)
    if obs_command_type == "base_velocity":
        return base_vel_command
    elif obs_command_type == "motion_command":
