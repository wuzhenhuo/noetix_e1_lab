...
from NoetixE1.assets.robots.e1.e1 import E1_12DOF_CFG, E1_12DOF_ACTION_SCALE  # isort:skip
...
class E1SceneCfg(InteractiveSceneCfg):
    ...
    height_scanner = RayCasterCfg(
        ...
        ray_alignment="yaw",
        pattern_cfg=patterns.GridPatternCfg(resolution=0.1, size=[1.5, 0.9]), # data = ((1.5/0.1)+1)*((0.9/0.1)+1) = 160
        debug_vis=True,
    )
...
class CommandsCfg:
    ...
    base_velocity = mdp.UniformVelocityWithZeroCommandCfg(
        asset_name="robot",
        resampling_time_range=(5.0, 10.0),
        rel_standing_envs=0.1,
        debug_vis=True,
        ranges=mdp.UniformVelocityWithZeroCommandCfg.Ranges(
            lin_vel_x=(-0.8, 1.0), lin_vel_y=(-0.5, 0.5), ang_vel_z=(-1.57, 1.57), zero_prob=[0.4, 0.4, 0.4]
        ),
    )
...
class ActionsCfg:
    ...
    joint_pos.scale = E1_12DOF_ACTION_SCALE
...
class RewardsCfg:
    ...
    joint_deviation_leg_l1 = RewTerm(
    ...
    #     func=mdp.base_height_deviation_l1,
    #     weight=0.5,
    #     params={"sensor_cfg": SceneEntityCfg("contact_sensor", body_names=".*_ankle_roll_link"), "target_height": 0.85, "feet_body_ids": [".*_ankle_roll_link"]},
    # )
...
class WalkRunFlatEnvCfg(ManagerBasedRLEnvCfg):
    ...
    def __post_init__(self) -> None:
        ...
        self.motion_files = sorted(glob.glob(f"{ASSET_DIR}/datasets/walkeun_12dof/e1/*"))
